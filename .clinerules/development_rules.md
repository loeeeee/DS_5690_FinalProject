...
Always use ROCm for accelerated tasks for local development.

Always use CUDA for accelerated tasks for HPC computation.

Always target RX 7900 XT and RTX 2080 Ti for GPU code.
